...
pub fn t(lang: Lang, key: Key) -> &'static str {
    ...
    match lang {
        Lang::En => match key {
            ...
            EmptyFolder => "This folder is empty. Press + to create or upload, or drop files on this page.",
        ...
        Lang::Tr => match key {
            ...
            EmptyFolder => "Bu klasör boş. + ile oluştur ya da yükle, ya da dosyaları bu sayfaya bırak.",
